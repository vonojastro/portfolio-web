...
const Hero = () => {
    return (
        <div className='max-h-screen mx-auto w-full lg:max-w-6xl'>
            <div className='flex justify-between gap-10 px-5 items-center w-full text-center min-h-screen  md:px-8'>
                <MyParticles
                    id='tsparticle'
                ...
                <div className='flex w-full  flex-col space-y-2 md:space-y-6 justify-center px-4 lg:px-0'>
