...
const Header = () => {
    ...
    return (
        <>
            ...
            <ul className={`absolute h-full opacity-100 z-[-5] w-full flex flex-col justify-center items-center top-[0] ${navOpen ? 'right-[0px]' : 'right-[-1000px]'} duration-300 ease-in-out space-y-12 py-10 bg-white md:w-5/12 lg:hidden`}>
                <li>Projects</li>
                <li>About</li>
                <li>Contact</li>
                <li>Resume</li>
