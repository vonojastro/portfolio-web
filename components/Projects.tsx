...
const ProjectSection = () => {
    return (
        ...
        <div className='w-full bg-[#171C23]'>
            <div className='min-h-screen mx-auto w-full items-center flex flex-col content-center md:flex-row lg:max-w-6xl '>
                ...
                {/* <div className='flex justify-center px-5 items-center w-full text-center min-h-screen  md:px-8'>
                <>
                    <Image
