          ...
          <div className='flex flex-col items-center justify-center px-5'>
            ...
            <form className='flex flex-col gap-4 md:gap-5 items-start w-full' onClick={onSubmit}>
              <div className='flex flex-col md:flex-row gap-4 w-full'>
                <input type='text' placeholder='Name' className='w-full px-5 py-1 md:py-2 rounded-sm' onChange={(e) => setContactInput({ ...contactInput, name: e.target.value })} />
                <input type='email' placeholder='Email' className='w-full px-5 py-1 md:py-2 rounded-sm' onChange={(e) => setContactInput({ ...contactInput, email: e.target.value })} />
              </div>
              <textarea className='w-full px-5 py-1 md:py-2 rounded-sm h-full min-h-[150px]' onChange={(e) => setContactInput({ ...contactInput, message: e.target.value })} />
